...
class PostgresBackend(StorageBackend):
    ...
    def normalize_sql(self, sql: str) -> str:
        # DurableStore emits a SQLite-compatible schema because SQLite is
        # the local source of truth. Normalize the few dialect differences
        # before sending schema/DML to Postgres.
        normalized = sql.replace("INTEGER PRIMARY KEY AUTOINCREMENT",
